...
CHANNEL_LAYERS = {
    "default": {
        ...
        "ROUTING": "scapyserver.routing.channel_routing",
    },
}
...
WSGI_APPLICATION = 'scapyserver.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, "servedstatic")
STATIC_URL = '/static/'
STATICFILES_DIRS = [
